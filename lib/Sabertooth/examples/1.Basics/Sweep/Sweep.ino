...
Sabertooth ST(128,Serial2); // The Sabertooth is on address 128. We'll name its object ST.
...
void setup()
{
  Serial2.begin(9600); // 9600 is the default baud rate for Sabertooth packet serial.
